...
Route::get('/puntosnivel','PuntosNivelController@main');
Route::post('/puntosnivel','PuntosNivelController@guardar');
Route::post('/getsitiosnivelcaudal','ApiController@getSitiosNivelCaudal');
Route::get('/getsitiosnivelcaudal','ApiController@getSitiosNivelCaudal');
...
Route::post('/getMedicionesPuntoNivelCaudal','ApiController@getMedicionesPuntoNivelCaudal');
Route::get('/getMedicionesPuntoNivelCaudal','ApiController@getMedicionesPuntoNivelCaudal');
Route::post('/registrarNivelCaudal','ApiController@registrarNivelCaudal');
Route::get('/registrarNivelCaudal','ApiController@registrarNivelCaudal');